...
goodDelim:                                ;[23]
	...
	MOV		#(10), R15                    ;[2] Set R15 to 9.

delimDelay:                               ;[n*4 + 7] (n = 10 to make this 1 Tari = 7.14 us)
	DEC		R15                           ;[2] Executed n times.
	JNZ		delimDelay                    ;[2] Executed n times.
...
startupT0A0_ISR:                          ;[21] cycles = 1.3125 us
	...
	CLR		&TA0R					      ;[4] Reset TAR value
	CLR		&(rfid.edge_capture_prev_ccr) ;[4] Clear previous value of CCR capture
	CLR		&(rfid.edge_capture_prev_ccr) ;[4] Reset previous edge capture time
	...
	;; We are already 153 cycles (9.5625 us) in since delimiter.
